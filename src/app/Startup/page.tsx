  ...
  return (
    ...
    <Navbar/>
     <div className='absolute w-[650px] h-60 top-52 left-28 flex flex-col gap-14  lg:top-40 lg:left-16'>
      <div className='w-full h-36  text-[56px] font-semibold leading-[65px] text-[#0D0E10] text-left'>Smart tools to Launch and Scale your ideas</div>
    ...
    <div className="flex justify-center items-center w-full h-[600px] mb-4">
      <div className='flex justify-center items-center w-[95%] text-center h-full border bg-[#EEEBEA] rounded-md'>
        <span className=' text-3xl m-10 font-bold ' >Insert Demo Video Here</span>
      <video
            muted
            loop
            autoPlay
