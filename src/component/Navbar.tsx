...
const Navbar = () => {
  return (
        ...
        <div className='flex justify-between  w-[95%]'>
         ...
         <div className='font-montserrat   text-xl lg:text-3xl font-semibold leading-6 text-left text-[#285B52]'>
         ...
         <div className="flex w-[455px] md:w-[400px] lg:w-[400px] h-12  items-center justify-between  pr-10 pl-10 md:pr-6 lg:pl-6 lg:pr-6 lg:pl-6">
