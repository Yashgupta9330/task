    ...
    <div className='bg-[#285B52] text-white w-full xlarge:px-[80px] xlarge:h-[80vh] xlarge:gap-0 sm:h-screen flex sm:flex-row flex-col sm:gap-[56px] items-center justify-around '>
      <div className=' top-0 w-full p-[20px] sm:w-1/2  '>
        ...
        <div className=' w-[90%] sm:w-[392px] xlarge:w-[50%] flex items-center  gap-[10px] sm:z-[9999] mt-[20px] sm:mt-[50px] '>
          <Link  href='/Startup'><button className='bg-white hover:bg-slate-200 w-[180px] xlarge:w-[100%] xlarge:h-[100px] mr-[10px] h-[56px] rounded-[12px] px-[24px] py-[14px] text-black font-bold xlarge:text-3xl'> Start-ups </button></Link>
         <Link href='/Investor'><button className='bg-[#7F39EB] hover:bg-[#9c5aff] w-[180px] xlarge:w-[100%] xlarge:h-[100px] h-[56px] rounded-[12px] px-[24px] py-[14px] text-white border border-[#E863FF] font-bold xlarge:text-3xl '>
            Investors
          </button></Link> 
        </div>
