    ...
    <div className='w-full h-[345px] bg-[#0D0E10] relative'>
      <div className="w-[309px] h-[114px] absolute top-[67px] left-[114px] ">
        ...
        <div className="flex flex-col gap-[16px] w-[288px] h-[94px]">
         ...
         <div className="w-[288px] h-[54px] p-[12px] gap-[10px] border border-[1px] rounded-[8px] border-gray-700  opacity-1 flex justify-center items-center">
           <InputButton/>
        </div>
        </div>
       </div>
      ...
      <div className="absolute w-[calc(100%-548px)]  top-[274px] left-[114px] gap-0  border border-[1px] border-t  border-[#555657] opacity-1"></div>
